...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.formLogin()
				.defaultSuccessUrl("/tradingCards")
			.and()
				.logout()
				.permitAll()
			.and()
    ...
    public ApplicationRunner initializeUsers(final PasswordEncoder passwordEncoder) {
        ...
        final User defaultUser = new User("user", passwordEncoder.encode("password"), "ROLE_USER");
		final User adminUser = new User("admin", passwordEncoder.encode("password"), "ROLE_ADMIN");
